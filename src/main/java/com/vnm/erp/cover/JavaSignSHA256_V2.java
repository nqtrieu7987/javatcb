...
public class JavaSignSHA256_V2 {

    public static void main(String[] arg) {
        try {

            String publicPath = "d:\\TCB\\other\\Singnature\\keystore\\KeyTestGrap\\mobivi.cer";
            ...
            String sSource1 = "AcctInqef4c7bc9-5a9d-43e1-851c-4a80392c7772T24TCS2TCBOWNERACCT19144556699669";
            //String signStr = signData_SHA256(sSource);
            String signStr1 = "";
            boolean result = verifySign_SHA256(sSource1, publicPath, signStr1);
        ...
        try {
            ...
            if (nl.getLength() == 0) {
                ...
                for (int i = 0; i < length; ++i) {
                    DOMValidateContext valContext = new DOMValidateContext(new X509KeySelector1(), nl.item(i));
...
class X509KeySelector1 extends KeySelector {
    public X509KeySelector1() {
    }
